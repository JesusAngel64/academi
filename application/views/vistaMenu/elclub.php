...
<html lang="es" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="CSS/elclub.css">
  ...
  <!-- para los iconos de redes sociales -->
    ...
    <section class="fondofotos">
      <h1 class="titulonuestrahistoria">NUESTRA HISTORIA</h1>
      <img class="imghis" src="img/1904.jpg" alt=""><p class="textoimgrigth">En este Campeonato aparecen las primeras<br>grandes figuras.</p>
      <h2 class="primerpartido">1ER PARTIDO CONOCIDO, 1ER PARTIDO DE CAMPEONATO</h2>
      <p class="texto">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
      <p class="texto"><strong>Luis Luna</strong>Arquero</p>
      <p class="texto"><strong>Luis Luna</strong>Arquero</p>
      <p class="texto"><strong>Luis Luna</strong>Arquero</p>
      <p class="texto"><strong>Luis Luna</strong>Arquero</p>
      <p class="texto"><strong>Luis Luna</strong>Arquero</p>
      <p class="texto"><strong>Luis Luna</strong>Arquero</p>
      <p class="texto">Este campeonato 1912 se jugo con siete equipos donde quedo campeon</p>
    </section>

    <section class="section intro">
      <div class="container">
        <h1>Nuestra Linea de Tiempo &rarr;</h1>
      </div>
    </section>
    ...
    <section class="timeline">
      ...
      <li>
       <div>
        <time>1985</time>
         In mattis elit vitae odio posuere.
      </div>
     </li>
