...
<section class="banner2">
  <img src="https://clubalianzalima.com.pe/static/media/uploads/Ads%20horizontal/web.jpg" alt="">
</section>
...
<section class="banner3">
  ...
  <div class="columnaX3">
		...
		<h5>7/11/20, 6:00 PM</h5>
		<p>Los abogados de este despacho estamos comprometidos con los mas altos valores éticos y ptuar, siempre apegados a la ley y a la moral nos distinguen de los demás</p>
	</div>
...
<footer>
      <div class="contenedor-footer">
        ...
        <div class="content-foo">
          <h4>Email</h4>
          <p>jesuschambi64@gmail.com</p>
        </div>

        <div class="content-foo">
          <h4>Location</h4>
          <p>Calle extranca rio seco Nº150</p>
        </div>
      </div>
      <h2 class="titulo-final">&copy; Angel </h2>
</footer>
    <!-- Minified JS library -->
